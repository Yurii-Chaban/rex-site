<?php get_header(); ?>
    ...
    <header id="header">
        <div class="header-inner">
            <!-- Header image -->
            <img src="http://rex.site.ua/wp-content/uploads/2016/03/header-bg.jpg" alt="img">
    ...
    <section id="testimonial">
        <img src="http://rex.site.ua/wp-content/uploads/2016/03/testimonial-bg.jpg" alt="img">
        <div class="counter-overlay">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        while ($the_query->have_posts()) : $the_query->the_post(); ?>
                                            ...
                                            <div class="single-slide">
                                                ...
                                                <div class="single-testimonial">
                                                    <span
                                                        class="testimonial-thumb"><?php the_post_thumbnail(); ?></span>
                                                    <p><?php the_title(); ?></p>
                                                    <span>
                                                        <?php
